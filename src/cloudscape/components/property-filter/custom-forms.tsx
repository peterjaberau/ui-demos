...
import { DatePicker, FormField, RadioGroup, TimeInput, TimeInputProps } from '@cloudscape-design/components';
...
import styles from './custom-forms.module.scss';

export function YesNoForm({ value, onChange }: any) {
  return (
    <FormField>
      <RadioGroup
...
export function DateTimeFormLegacy(props: any) {
  return <DateTimeForm {...props} legacy={true} />;
}

export function DateForm({ filter, value, onChange }: any) {
