...
export default function TabsDemoPage() {
  const [tabsDismissibles, setTabDismissibles]: any = useState([
    {
      label: 'First tab',
      id: 'first',
      dismissible: true,
      dismissLabel: 'Dismiss first tab (dismissibles variant)',
      onDismiss: () => setTabDismissibles((prevTabs: any) => prevTabs.slice(1)),
      content: (
        <>
    ...
    },
    {
      ...
      onDismiss: () => setTabDismissibles((prevTabs: any) => prevTabs.filter((tab:any) => tab.id !== 'second')),
      content: (
        <>
