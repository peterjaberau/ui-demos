...
const generateFakeItems = (pageNumber: number): any => {
...
export default class App extends React.Component {
  ...
  handleLoadItems: any = ({ detail: { filteringText, firstPage } }: any) => {
  ...
  handleChange: any = (event: any) => this.setState({ value: event.detail.selectedOption });
