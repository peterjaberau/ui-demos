...
export function createLinearTimeLatencyProps() {
  ...
  const xScaleType: any = 'linear';
  const yScaleType: any = 'linear';
...
export function createLogXYProps({ xLog, yLog }: { xLog?: boolean; yLog?: boolean }) {
  ...
  const xScaleType: any = xLog ? 'log' : 'linear';
  const yScaleType: any = yLog ? 'log' : 'linear';
...
export function createCategoricalProps() {
  ...
  const xScaleType: any = 'categorical';
  const yScaleType: any = 'linear';
