...
import { Board, BoardItem, BoardProps, ItemsPalette } from "@cloudscape-design/board-components";
import { ItemsPaletteProps } from '@cloudscape-design/board-components';
